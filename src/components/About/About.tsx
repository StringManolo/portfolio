...
const About = () => {
  ...
  const handleAnimationEnd = () => {
    const image = document.querySelector('#pencil-sketch') as HTMLImageElement;
    if (image) {
  ...
  const handleSketchImageClick = () => {
    const imageColor = document.querySelector('#no-pencil-sketch') as HTMLImageElement;
    if (imageColor) {
  ...
  const handleNoSketchImageClick = () => {
    ...
    if (imageColor) {
      ...
      const aboutDescriptionContainer = document.querySelector('#about-description-container') as HTMLDivElement;
